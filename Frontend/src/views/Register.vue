<template>
    <div class="bg-white p-8 rounded-lg shadow-md max-w-md w-full mx-auto mt-10">
        ...
        <form @submit.prevent="handleRegister" class="space-y-6">
            ...
            <button type="submit" :disabled="loading" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 hover:cursor-pointer">
                Registrarse
            </button>
        </form>
